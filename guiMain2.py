...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(110, 640, 331, 90))
        self.horizontalLayoutWidget.setObjectName("horizontalLayoutWidget")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget)
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.buttonAcquire = QtWidgets.QPushButton(self.horizontalLayoutWidget)
        ...
        self.buttonSnap = QtWidgets.QPushButton(self.horizontalLayoutWidget)
        ...
        self.groupBoxLasersSettings.setGeometry(QtCore.QRect(1440, 80, 441, 271))
        font = QtGui.QFont()
        font.setFamily("Berlin Sans FB")
        font.setPointSize(12)
...
"border-color: rgb(0, 0, 0);")
        ...
        self.groupBoxPALMAcquisition.setGeometry(QtCore.QRect(1440, 390, 441, 181))
        font = QtGui.QFont()
        font.setFamily("Berlin Sans FB")
        font.setPointSize(12)
        self.groupBoxPALMAcquisition.setFont(font)
        self.groupBoxPALMAcquisition.setObjectName("groupBoxPALMAcquisition")
        self.pushButtonAcquirePALMSingle = QtWidgets.QPushButton(self.groupBoxPALMAcquisition)
        self.pushButtonAcquirePALMSingle.setGeometry(QtCore.QRect(310, 36, 111, 51))
        self.pushButtonAcquirePALMSingle.setObjectName("pushButtonAcquirePALMSingle")
        self.horizontalLayoutWidget_2 = QtWidgets.QWidget(self.groupBoxPALMAcquisition)
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(20, 40, 261, 41))
        self.horizontalLayoutWidget_2.setObjectName("horizontalLayoutWidget_2")
        self.horizontalLayoutPALM = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget_2)
        self.horizontalLayoutPALM.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayoutPALM.setObjectName("horizontalLayoutPALM")
        self.labelImageNumber = QtWidgets.QLabel(self.horizontalLayoutWidget_2)
        self.labelImageNumber.setObjectName("labelImageNumber")
        self.horizontalLayoutPALM.addWidget(self.labelImageNumber)
        self.spinBoxImageNumber = QtWidgets.QSpinBox(self.horizontalLayoutWidget_2)
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(549, 1020, 841, 84))
        self.verticalLayoutWidget_2.setObjectName("verticalLayoutWidget_2")
        self.verticalLayoutSliders = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_2)
        self.verticalLayoutSliders.setContentsMargins(0, 0, 0, 0)
        self.verticalLayoutSliders.setObjectName("verticalLayoutSliders")
        self.labelMinimum = QtWidgets.QLabel(self.verticalLayoutWidget_2)
        ...
        self.horizontalSliderMinimum = QtWidgets.QSlider(self.verticalLayoutWidget_2)
        ...
        self.labelMaximum = QtWidgets.QLabel(self.verticalLayoutWidget_2)
        ...
        self.horizontalSliderMaximum = QtWidgets.QSlider(self.verticalLayoutWidget_2)
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 2111, 21))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButtonAcquirePALMSequence.setText(_translate("MainWindow", "Sequence"))
